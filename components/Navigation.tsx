  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-8 h-8 bg-white flex items-center justify-center rounded-sm group-hover:bg-yellow-500 transition-colors">
          ...
          <span className="text-lg font-bold tracking-tighter uppercase hidden sm:block">
            Public AI <span className="text-yellow-500">Champion</span>
          </span>
        </div>
